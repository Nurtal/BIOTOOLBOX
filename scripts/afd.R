...
if(identical(os, "Windows")){
  ...
  ## output file name
  png_path_overview = paste("C:\\Users\\", login, "\\Desktop\\Nathan\\SpellCraft\\BIOTOOLBOX\\input\\output\\", sep="")
  lda_prior_file = paste("C:\\Users\\", login, "\\Desktop\\Nathan\\SpellCraft\\BIOTOOLBOX\\input\\output\\lda_prior_file.csv", sep="")
...
## Load data on Linux
  ...
  ## input file name
  data_file_name = paste("/home/foulquier/Bureau/SpellCraft/WorkSpace/Github/BIOTOOLBOX/input/data.csv", sep="")
  
  ## output file name
  png_path_overview = "/home/foulquier/Bureau/SpellCraft/WorkSpace/Github/BIOTOOLBOX/output/images/"
  lda_prior_file = "/home/foulquier/Bureau/SpellCraft/WorkSpace/Github/BIOTOOLBOX/output/lda_prior_file.csv"
  lda_count_file = "/home/foulquier/Bureau/SpellCraft/WorkSpace/Github/BIOTOOLBOX/output/lda_count_file.csv"
  lda_number_file = "/home/foulquier/Bureau/SpellCraft/WorkSpace/Github/BIOTOOLBOX/output/lda_number_file.csv"
  lda_means_file = "/home/foulquier/Bureau/SpellCraft/WorkSpace/Github/BIOTOOLBOX/output/lda_means_file.csv"
  lda_scaling_file = "/home/foulquier/Bureau/SpellCraft/WorkSpace/Github/BIOTOOLBOX/output/lda_scaling_file.csv"
